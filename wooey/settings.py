...
# Kubernetes settings
WOOEY_KUBERNETES = get('WOOEY_KUBERNETES', False)
KUBERNETES_NAMESPACE = get('KUBERNETES_NAMESPACE', None)
KUBERNETES_KIBANA_URL = get('KUBERNETES_KIBANA_URL', '')
KUBERNETES_CLAIM = get('KUBERNETES_CLAIM', None)
KUBERNETES_MOUNT_PATH = get('KUBERNETES_MOUNT_PATH', None)

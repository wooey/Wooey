...
PY_FULL_VERSION = StrictVersion(f'{sys.version_info.major}.{sys.version_info.minor}.{sys.version_info.micro}')
PY_MINOR_VERSION = StrictVersion(f'{sys.version_info.major}.{sys.version_info.minor}')

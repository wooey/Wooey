    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(to='wooey.WooeyJob', on_delete=models.PROTECT)),
                ('parameter', models.ForeignKey(blank=True, to='wooey.ScriptParameters', null=True, on_delete=models.PROTECT)),
            ],
